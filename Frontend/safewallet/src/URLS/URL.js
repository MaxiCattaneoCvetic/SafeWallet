...
const URL_GET_USER_ACCOUNT = `${URL_GATEWAY}/accountFull/`;
...
export {CLIENT_ID_KEYCLOAK,REGISTER_USER_KEYCLOAK,REGISTER_USER_FULL,APPLICATION_LOGIN,URL_GET_USER_ACCOUNT,URL_APP,URL_LOGOUT}
